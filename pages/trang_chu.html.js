        ...
        <>
            <Head>
                <>
                    ...
                    <title>Trang chủ Quản Lý Chung Chuyển đổi số 365</title>
                    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
                    <meta
                        name="description"
                        content="Trang quản lý chung Chuyển đổi số 365. Quản lý các phần mềm, tiện ích trong hệ thống chuyển đổi số 365"
                    />
                    <meta
                        property="og:title"
                        content="Trang chủ Quản Lý Chung Chuyển đổi số 365"
                    />
                    ...
                    <link
                        ...
                        crossOrigin="anonymous"
                    />
                    <link rel="preload" as="style" href="../css/style_chat_box.css" />
                    <link
                        rel="stylesheet"
                        media="all"
                                ...
                                <div className="ctn_butth">
                                    ...
                                    <div className="bgr_froh">
                                        <div className="fonh_one">
                                            <h1 className="share_clr_tow cr_weight_bold">
                                                Chuyển đổi số 365
                                            </h1>
                                            <p className="share_clr_tow">
                                                Giải pháp chuyển đổi số được tin dùng bởi +10.000 doanh nghiệp
                                                hàng đầu. Chuyển đổi số 365 mang thành công đột phá đến doanh
                                                nghiệp.
                                            </p>
                                        </div>
                                        <div className="show_hide">
                                            <div className="name_title_dl">
