...
export default function RegisterEp() {
  ...
  return (
    <>
      <Seo seo='' title='Trang đăng ký nhân viên' />
      <Header />
          ...
          <div className='content_nv'>
            <div className='ctn_register_nv'>
              <form
                ...
                className='regnv_form regnv_form_dk'>
                        ...
                        <div className='ctn_form edit_tt_form share_distance'>
                          ...
                          <div className='form-row'>
                            <div className='form-group'>
                              ...
                              />
                              {errors && errors.phoneTK && (
                                <label className='error'>
                                  {errors.phoneTK.message}
                                </label>
                              )}
                            </div>
                            <div className='form-group'>
                          ...
                          <div className='form-row'>
                            ...
                            <div className='form-group'>
                              ...
                              />
                              {errors && errors.res_password && (
                                <label className='error'>
                                  {errors.res_password.message}
                                </label>
                              )}
                            </div>
                          </div>
