...
import Modal_Update_dispatch from "@/components/VanThu/management_dispatch/model-dispatch/Model_Update_dispatch";
  ...
  return (
    <div className={styles.container}>
      ...
      <Modal_Update_dispatch
        href={`/VanThu/ds-van-ban/vb-den/${dataDetail?._id}`}
