...
import { select_style } from "@/pages/VanThu/trang-chu-quan-ly-cong-van/cai-dat-quan-ly-cong-van";
...
import { Sended_status, Received_status, Accepted_status, NotAccepted_status, Force_to_work_status, Wait_other_accept } from "./danh-sach-de-xuat";
import styles from './style_data_delete.module.css';
      ...
      <div className={styles.list_tab}>
        ...
        <div className={styles.tab_content}>
          ...
          {table_records?.map((record:any, index:any) => {
            return(
              <a key={index} href={"/VanThu/trang-quan-ly-de-xuat/" + record._id} className={styles.link_record}>
...
const Index = () => {
  ...
  const handlePageChange = async (e: any) => {
    ...
    setTableRecords(response?.data.listDeXuatUser);
  };
