...
import Modal_del_contract from "@/components/VanThu/management_dispatch/modal_contract/Model_del";
import Modal_Update_contract from "@/components/VanThu/management_dispatch/modal_contract/Model_contract_update";
  ...
  return (
    <div className={styles.container}>
      ...
      <Modal_Update_contract
        href={`/VanThu/VanThu/ds-hop-dong/hop-dong-den`}
