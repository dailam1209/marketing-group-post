          ...
          <div className='cnt_count_tab'>
            <div className='cnt_counts_one'>
              <div className='cnt_counts'>
                <label
                  ...
                  <p
                    className='share_fsize_three share_clr_one tex_center share_cursor'
                    onClick={showAll}>
                    Tất cả
                  </p>
                </label>
              ...
              <div className='cnt_counts'>
                <label
                  htmlFor=''
                  className={`pmc_all ${active == 'nhan_luc' ? 'active' : ''}`}
                  data-tab='list_detl_two'>
                  <p
                    className='share_fsize_three share_clr_one tex_center share_cursor'
                    onClick={showNhanluc}>
                    Quản lý nhân lực
              ...
              <div className='cnt_counts'>
                <label
                  htmlFor=''
                  className={`pmc_all ${active == 'cong_viec' ? 'active' : ''}`}
                  data-tab='list_detl_three'>
                  <p
                    className='share_fsize_three share_clr_one tex_center share_cursor'
                    onClick={showCongviec}>
                    Quản lý công việc
                  </p>
                </label>
              </div>
            ...
            <div className='cnt_counts_tow'>
              <div className='cnt_counts'>
                <label
                  htmlFor=''
                  className={`pmc_all ${active == 'noi_bo' ? 'active' : ''}`}
                  data-tab='list_detl_four'>
                  <p
                    className='share_fsize_three share_clr_one tex_center share_cursor'
                    onClick={showNoibo}>
                    Quản lý nội bộ
              ...
              <div className='cnt_counts'>
                <label
                  htmlFor=''
                  className={`pmc_all ${active == 'ban_hang' ? 'active' : ''}`}
                  data-tab='list_detl_five'>
                  <p
                    className='share_fsize_three share_clr_one tex_center share_cursor'
                    onClick={showBanhang}>
                    Quản lý bán hàng
            ...
            <div className='ctn_mr'>
              ...
              <div className='one_bod_td'>
                ...
                <p className='ntq_titlp share_clr_one'>
                  <span className='cr_weight'>Chuyển đổi số 365</span> là nền
                  tảng quản trị doanh nghiệp phổ biến, được tin dùng bởi hơn
                  10,000 doanh nghiệp thuộc nhiều lĩnh vực khác nhau. Hầu hết
                  các doanh nghiệp dẫn đầu thị trường và các công ty tăng trưởng
                  nhanh đang dùng một trong số các sản phẩm của{' '}
                ...
                <p className='ntq_titlp share_clr_one'>
                  ...
                  dụng dễ dàng trên trình duyệt, smartphone (iOS, Android), máy
                  tính bảng, hoặc cài đặt trên máy tính để bàn.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className='detal_titl'>
                    ...
                    <a
                      ...
                      <div className='pcm_detl_titl'>
                        ...
                        <p className='share_clr_one tex_left share_fsize_one'>
                          Giải pháp tìm phòng trọ, người thuê trọ nhanh chóng,
                          miễn phí.
                        </p>
                      </div>
                  ...
                  <div className='ctn_detl_one'>
                    <a
                      ...
                      <div className='pcm_detl_titl'>
                        ...
                        <p className='share_clr_one tex_left share_fsize_one'>
                          Cập nhật hàng triệu việc làm tự do với mức lương hấp
                          dẫn.
                        </p>
                      </div>
                      <div className='pcn_delt_hrf'>
                  ...
                  <div className='ctn_detl_one'>
                    <a
                      ...
                      <div className='pcm_detl_titl'>
                        ...
                        <p className='share_clr_one tex_left share_fsize_one'>
                          Kết nối với gia sư đa môn học, ở mọi tỉnh thành, dễ
                          dàng, nhanh chóng.
                        </p>
                      </div>
                      <div className='pcn_delt_hrf'>
                  ...
                  <div className='ctn_detl_one'>
                    <a
                      ...
                      <div className='pcm_detl_titl'>
                        ...
                        <p className='share_clr_one tex_left share_fsize_one'>
                          Cập nhật liên tục các khóa học đa dạng môn học từ
                          offline và online.
                        </p>
                      </div>
                      <div className='pcn_delt_hrf'>
                  ...
                  <div className='ctn_detl_one'>
                    <a
                      ...
                      <div className='pcm_detl_titl'>
                        ...
                        <p className='share_clr_one tex_left share_fsize_one'>
                          Cung cấp danh bạ của tất cả các công ty lớn nhỏ trên
                          toàn quốc.
                        </p>
                      </div>
                      <div className='pcn_delt_hrf'>
                  ...
                  <div className='ctn_detl_one'>
                    <a
                      ...
                      <div className='pcm_detl_titl'>
                        ...
                        <p className='share_clr_one tex_left share_fsize_one'>
                          Tra cứu thông tin lương theo vị trí công việc chính
                          xác, nhanh chóng.
                        </p>
                      </div>
                      <div className='pcn_delt_hrf'>
                  ...
                  <div className='ctn_detl_one'>
                    <a
                      ...
                      <div className='pcm_detl_titl'>
                        ...
                        <p className='share_clr_one tex_left share_fsize_one'>
                          Đăng tải thông tin rao vặt miễn phí, cập nhật liên tục
                          mỗi ngày.
                        </p>
                      </div>
                      <div className='pcn_delt_hrf'>
                  ...
                  <div className='ctn_detl_one'>
                    <a
                      ...
                      <div className='pcm_detl_titl'>
                        ...
                        <p className='share_clr_one tex_left share_fsize_one'>
                          Thỏa sức vi vu với kho vé máy bay nội địa, quốc tế với
                          giá rẻ bất ngờ.
                        </p>
                      </div>
                      <div className='pcn_delt_hrf'>
                  ...
                  <div className='ctn_detl_one'>
                    <a
                      ...
                      <div className='pcm_detl_img tex_center'>
                        <img
                          src='../img/theo-cao.png'
                          alt='Thẻ cào điện thoại'
                        />
                      </div>
                      <div className='pcm_detl_titl'>
                        <h4 className='share_clr_four cr_weight_bold tex_left'>
          ...
          <div className='container'>
            <div className='detail_four'>
              ...
              <p className='cds_titl share_clr_one'>
                Ngay từ thời điểm doanh nghiệp hình thành,các thiết bị chấm công
                kết hợp với việc điểm danh cơ học của nhân sự trở thành căn cứ
                tiêu biểu giúp các công ty ghi lại được thời điểm đến làm việc,
                tan làm, nghỉ phép của người lao động từ đó, tính công và lương,
                thưởng cho người lao động vào cuối tháng một cách chính xác,
                đồng thời góp phần nâng cao ý thức làm việc và kỷ luật của nhân
