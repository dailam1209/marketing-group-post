                              ...
                              {show == 'all' ? (
                                 <Row gutter={[24, 36]}>
                                    <Col xxl={6} sm={12} md={12} xl={8} xs={24} onClick={() => setOpenModalConfirm(true)}>
                                       <QLC_item title='Chấm công' img={'../img/qlc_cc.png'} />
                                    </Col>
                                    <Col xxl={6} sm={12} md={12} xl={8} xs={24} onClick={() => setOpenModalConfirm(true)}>
                                    ...
                                    <Col xxl={6} sm={12} md={12} xl={8} xs={24} onClick={() => setOpenModalConfirm(true)}>
                                       <QLC_item title='Quản trị nhân sự' img={'../img/qlc_ns.png'} url='/quan-ly-nhan-luc' />
                                    </Col>
                                    <Col xxl={6} sm={12} md={12} xl={8} xs={24} onClick={() => setOpenModalConfirm(true)}>
                                    ...
                                    <Col xxl={6} sm={12} md={12} xl={8} xs={24} onClick={() => setOpenModalConfirm(true)}>
                                       <QLC_item title='Phần mềm CRM' img={'../img/qlc_crm.png'} />
                                    </Col>
                                    <Col xxl={6} sm={12} md={12} xl={8} xs={24} onClick={() => setOpenModalConfirm(true)}>
