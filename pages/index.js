              ...
              <div className="content_ql">
                ...
                <div className="ctn_1">
                  ...
                  <div className="ctn_1_right">
                    ...
                    <span>
                      Chuyển đổi số 365 là nền tảng quản trị doanh nghiệp phổ
                      biến, được tin dùng bởi hơn 10,000 doanh nghiệp thuộc
                      nhiều lĩnh vực khác nhau. Hầu hết các doanh nghiệp dẫn đầu
                      thị trường và các công ty tăng trưởng nhanh đang dùng một
                      trong số các sản phẩm của chuyển đổi số 365
                    </span>
                    <span>
                      Tất cả các ứng dụng trên Chuyển đổi số 365 có thể sử dụng
                      dễ dàng trên trình duyệt, smartphone (iOS, Android), máy
                ...
                <div className="ctn_3">
                  ...
                  <div className="ctn_3_wrap">
                    ...
                    <div className="ctn_3_right">
                      <h2>Bước 2: Đăng ký tài khoản</h2>
                      <span>
                        Bạn hãy truy cập website hoặc app Chấm công 365 để đăng
                        ký tài khoản. Đối với tài khoản công ty, chọn mục "Công
                        ty" và điền đầy đủ thông tin đăng ký tài khoản. Lưu ý
                        đối với tạo tài khoản nhân viên có 2 cách để tạo tài
                        khoản:
                      </span>
                      <span>
                        Cách 1: Nhân viên tự đăng ký tài khoản bằng cách nhập ID
                        công ty do nhân sự cung cấp và điền đầy đủ thông tin
                        đăng ký
                      </span>
                      <span>
                        Cách 2: Công ty tạo tài khoản cho nhân viên bằng cách
                        đăng nhập tài khoản công ty và thêm mới tài khoản cho
                        nhân viên.
                      </span>
                      <span>
                        Sau khi điền đầy đủ thông tin, hệ thống sẽ gửi về email
                        đăng ký mã OTP để xác thực tài khoản, người dùng nhập mã
                        OTP để có thể bắt đầu sử dụng.
                      </span>
                      <span>
                        Công ty và nhân viên đăng nhập bằng tài khoản đó trên
                        các phần mềm của hệ sinh thái 365 để quản lý doanh
                        nghiệp, trong đó có phần mềm tính lương 365 để thiết
                        lập, quản lý và theo dõi công lương.
                      </span>
                    </div>
                  </div>
                </div>
                <div className="ctn_4">
                  ...
                  <div className="ctn_4_wrap">
                    ...
                    <div className="ctn_4_right">
                      <h2>Bước 3: Thiết lập dữ liệu</h2>
                      <span>
                        Sau khi hoàn tất quá trình đăng ký, bạn đăng nhập hệ
                        thống để thiết lập các trường nhằm mục đích hỗ trợ hệ
                        thống tính lương chính xác nhất.{" "}
                      </span>
                      <span>
                        Danh sách nhân viên: toàn bộ nhân viên trong công ty đã
                        đăng ký tài khoản trên hệ thống. Nhân sự thao tác nhập
                        lương cơ bản, lương tính bảo hiểm (nếu không tính bảo
                        hiểm theo lương cơ bản), Hợp đồng và phần trăm lương
                        tương ứng, số người
                      </span>
