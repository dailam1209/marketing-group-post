...
const Cackhoantienkhac = () => {
  ...
  const token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..MWhhTFyh-RReArRAwzWMFCScVKe1md2puftWCzxQBv4";
  const cp = 1664;
  useEffect(() => {
    fetchApiData();
  }, []);
  const fetchApiData = () => {
    axios
      .post(`${domain}/api/tinhluong/congty/show_other_money`, {
        token: token,
        cl_com: cp,
      })
      .then((response) => {
        setApiData(response.data.listdata);
      })
      .catch((error) => {
      ...
      <div className={styles.container}>
        <div className={styles.content}>
                ...
                <div>
                  <div>
                    ...
                    <p className={styles.text}>
                      {card?.TinhluongFormSalary?.[0]?.fs_note}
                    </p>
                  </div>
                  <div>
                    <p className={styles.write}>
              ...
              >
                <div>
                  <div>
                    ...
                    <p className={styles.text}>{card.policyDescription}</p>
                  </div>
                  <div>
                    <p className={styles.write}>
                      <Image
          ...
          <div className={styles.video}>
            <iframe
              ...
              width={680}
              height={430}
              src="https://www.youtube.com/embed/3ETg5XAbP8A"
        ...
        <div className="modalRecipe">
          <Modal
            ...
            title="Công thức các khoản tiền khác"
                ...
                <div className={styles.modalRecipe_left}>
                  <div className={styles.input_after}>
                    <input
                      ...
                      placeholder="Thêm tên công thức"
        ...
        <div className="myModal">
          <Modal
            ...
            style={{ display: "flex", flexDirection: "column" }}
            title="Thêm mới khoản tiền khác"
            open={isModalOpen}
            onCancel={handleCancel}
            footer={null}
          >
            <div className={styles.modal_body}>
              <label className={styles.p}>Tên khoản tiền khác:</label>
              <input
                type="text"
                id="policy-name"
                placeholder="Nhập tên tên loại tiền"
                className={styles.input}
                value={policyName}
...
export default Cackhoantienkhac;
