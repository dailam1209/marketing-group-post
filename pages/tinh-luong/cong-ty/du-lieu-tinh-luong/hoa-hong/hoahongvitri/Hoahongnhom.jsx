...
import { DatePicker, Table, Select, Modal, Button, Input, Form, Space, Radio } from "antd";
      ...
      <div className={styles.container}>
         <div className={styles.content}>
            <div className={styles.information}>
               <div>
                  <h3 className={styles.h3}>Danh sách nhóm hưởng hoa hồng lệ phí vị trí</h3>
                  <p className={styles.p_style}>Quản lý theo dõi nhóm hưởng hoa hồng lệ phí vị trí</p>
               </div>
               <div>
         ...
         <div className="modalRecipe">
            <Modal className={styles.modal_edit} title="Thêm mới hoa hồng nhóm" open={isModalOpen} onCancel={handleModalCancer} footer={null}>
                  ...
                  <div className={styles.format}>
                     ...
                     <div className={styles.flex}>
                        <div className={styles.flex_input}>
                           ...
                           <input type="number" className={styles.input} placeholder="Nhập số lượng sản phẩm" value={editMoney} onChange={(e) => setEditMoney(e.target.value)} />
                        </div>
                        <div className={styles.flex_input}>
                                    ...
                                    <Space
                                       ...
                                       <div className={styles.flex}>
                                          <div className={styles.flex_input}>
                                             ...
                                             <input type="number" className={styles.input_ant} placeholder="Nhập số lượng sản phẩm" value={editMoney} onChange={(e) => setEditMoney(e.target.value)} />
                                          </div>
