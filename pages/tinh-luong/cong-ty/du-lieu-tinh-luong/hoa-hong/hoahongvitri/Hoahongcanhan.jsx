      ...
      <div className={styles.container}>
         <div className={styles.content}>
            <div className={styles.information}>
               <div>
                  <h3 className={styles.h3}>Danh sách nhân viên hưởng hoa hồng lệ phí vị trí</h3>
                  <p className={styles.p_style}>Quản lý theo dõi nhân viên hưởng hoa hồng lệ phí vị trí</p>
               </div>
               <div>
         ...
         <div className="modalRecipe">
            <Modal className={styles.modal_edit} title="Thêm mới hoa hồng vị trí" open={isModalOpen} onCancel={handleModalCancer} footer={null}>
