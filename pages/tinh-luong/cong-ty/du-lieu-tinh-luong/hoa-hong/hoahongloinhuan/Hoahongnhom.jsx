      ...
      <div className={styles.container}>
         <div className={styles.content}>
            <div className={styles.information}>
               <div>
                  <h3 className={styles.h3}>Danh sách nhóm hưởng hoa hồng lợi nhuận</h3>
                  <p className={styles.p_style}>Quản lý theo dõi nhóm nhân viên hoa hồng lợi nhuận</p>
               </div>
               <div>
         ...
         <div className="modalRecipe">
            <Modal className={styles.modal_edit} title="Thêm mới hoa hồng tiền" open={isModalOpen} onCancel={handleModalCancer} footer={null}>
                  ...
                  <div className={styles.format}>
                     ...
                     <div className={styles.flex}>
                        <div className={styles.flex_input}>
                           ...
                           <input type="number" className={styles.input_css} placeholder="Nhập số lượng" value={editMoney} onChange={(e) => setEditMoney(e.target.value)} />
                        </div>
                        <div className={styles.flex_input}>
                           <input type="number" className={styles.input_css} placeholder="Nhập doanh thu" value={editMoney} onChange={(e) => setEditMoney(e.target.value)} />
                        </div>
                        <div className={styles.flex_input}>
