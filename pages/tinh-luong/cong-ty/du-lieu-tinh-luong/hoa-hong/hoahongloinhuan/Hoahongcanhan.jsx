      ...
      <div className={styles.container}>
         <div className={styles.content}>
            <div className={styles.information}>
               <div>
                  <h3 className={styles.h3}>Danh sách nhân viên hưởng hoa hồng lợi nhuận</h3>
                  <p className={styles.p_style}>Quản lý theo dõi nhân viên hưởng hoa hồng lợi nhuận</p>
               </div>
               <div>
         ...
         <div className={styles.content_bot}>
            <div className={styles.video}>
               <iframe
                  ...
                  width={680}
                  height={430}
                  src="https://www.youtube.com/embed/ZcbtD7yZE-Q"
         ...
         <div className="modalRecipe">
            <Modal className={styles.modal_edit} title="Thêm mới hoa hồng lợi nhuận" open={isModalOpen} onCancel={handleModalCancer} footer={null}>
