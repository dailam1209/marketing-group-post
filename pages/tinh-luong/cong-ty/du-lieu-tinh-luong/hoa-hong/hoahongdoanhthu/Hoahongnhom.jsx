      ...
      <div className={styles.container}>
         <div className={styles.content}>
            <div className={styles.information}>
               <div>
                  <h3 className={styles.h3}>Danh sách nhóm nhân viên hoa hồng doanh thu</h3>
                  <p className={styles.p_style}>Quản lý theo dõi nhóm nhân viên hoa hồng doanh thu</p>
               </div>
               <div>
         ...
         <div className="modalRecipe">
            <Modal className={styles.modal_edit} title="Thêm mới hoa nhóm" open={isModalOpen} onCancel={handleModalCancer} footer={null}>
