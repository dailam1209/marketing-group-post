...
const TongHopBaoHiemNhanVien = () => {
  ...
  const handleExportExcel = () => {
    ...
    apiData?.forEach((item) => {
      const rowData = [
        ...
        item.luong_bao_hiem, // Lương đóng bảo hiểm
        item.tong_bao_hiem, // Bảo hiểm
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (record) => <p>{record?.luong_bao_hiem}</p>,
      width: "15%",
      editable: true,
    },
    {
      title: "Bảo hiểm",
      render: (record) => <p>{record?.tong_bao_hiem}</p>,
      width: "10%",
      editable: true,
    },
    {
      ...
      <div className={styles.part_hps}>
        <div className={styles.cate_taff}>
          <div className={styles.cate_staff_one}>
            <div className={styles.prl_part_one_cate_part_payr}>
              <h3>Tổng hợp thông tin bảo hiểm của nhân viên</h3>
            </div>
            <div>
              <Form
                onFinish={onFinish}
        ...
        <div className={styles.cate_pay_ct}>
          <a className={styles.xuat_excel} onClick={handleExportExcel}>
            <p>Xuất file tổng hợp bảo hiểm</p>
          </a>
        </div>
      </div>
    </div>
...
export default TongHopBaoHiemNhanVien;
