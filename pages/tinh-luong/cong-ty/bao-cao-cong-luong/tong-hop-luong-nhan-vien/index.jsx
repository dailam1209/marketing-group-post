...
const TongHopLuongNhanVien = () => {
  ...
  const handleExportExcel = () => {
    const data = [
      ["Họ và tên", "Tổng lương", "Bảo hiểm", "Thuế", "Tổng lương thực nhận"],
    ];
        ...
        <div className={styles.cate_taff}>
          <div className={styles.cate_staff_one}>
            <div className={styles.prl_part_one_cate_part_payr}>
              <h3>Tổng hợp lương nhân viên theo chu kỳ</h3>
            </div>
            <div>
              <Form
                onFinish={onFinish}
...
export default TongHopLuongNhanVien;
