...
const Nhansudathietlap = () => {
   ...
   const columnsTable = [
      ...
      ,
      {
         ...
         render: () => (
            <div>
               <Image alt="/" src={"/add-icon.png"} width={15} height={15} onClick={showModalTimeConfirm} />
            </div>
         ),
      },
      ,
   ...
   const dataTable = [
      {
         key: "1",
         name: "John Brown",
         policy: "Thuế theo hệ số cố định",
         recipe: "Quy định nhà nước năm 2021",
         apply: "Tháng 06/2023",
         end: "Tháng 08/2023",
      },
      {
      ...
      <div className={styles.container}>
         <div className={styles.content}>
            <div className={styles.information}>
               <h3 className={styles.h3}>Danh sách nhân viên đã áp dụng thuế</h3>
            </div>
         ...
         <div>
            <div className={styles.video}>
               <iframe
                  ...
                  width={680}
                  height={430}
                  src="https://www.youtube.com/embed/fVqDZ7ddSoE"
