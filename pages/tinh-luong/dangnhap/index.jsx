        ...
        <div className={styles.idx_bg}>
          <picture>
            <source
              ...
              srcSet={"https://tinhluong.timviec365.vn/img/bg_index_mb_min.png"}
            />
            <source
            ...
            <div className={styles.box_udiem}>
              ...
              <div className={styles.box_udvt}>
                ...
                <div className={styles.nd_udvt}>
                  ...
                  <p className={styles.p}>
                    ...
                    dùng giải quyết toàn diện đối với từng doanh nghiệp cụ thể.
                  </p>
                  <a>Xem chi tiết →</a>
                </div>
              </div>
              <div className={styles.box_udvt_box_mr_ud_box_mr_ud2}>
                ...
                <div className={styles.nd_udvt}>
                  ...
                  <p className={styles.p}>
                    Luôn đồng hành và hỗ trợ 24/7. Phù hợp với cả những tập đoàn
                    xuyên quốc gia đến những công ty SME.
                  </p>
                  <a>Xem chi tiết →</a>
                </div>
              </div>
