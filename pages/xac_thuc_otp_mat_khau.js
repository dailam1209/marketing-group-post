...
export default function xac_nhan_otp_mat_khau() {
    return (
        <>
            <>
                <meta charSet="UTF-8" />
                ...
                <div className="content_ql ctn_bgr_body">
                    <div className="content_nv">
                        <div className="ctn_register_nv">
                            <form onsubmit="return false" className="regnv_form regnv_form_otp_nv">
                                            ...
                                            <div className="tow_reg_ql share_reg_log share_brd_radius share_bgr_tow ctn_register_nv">
                                                <div className="header_qmk">
                                                    ...
                                                    <div className="qmk_avt_ic">
                                                        <img src="../img/tow_page_qmk.png" alt="" />
                                                    </div>
                                                </div>
                                                ...
                                                <div className="center_form">
                                                    <div className="form-group">
                                                        ...
                                                        <input id="partitioned" maxLength={6} placeholder="" />
                                                    </div>
                                                ...
                                                <div className="form-butt-one">
                                                    ...
                                                    <p className="quay_lai tex_center share_clr_one share_cursor share_fsize_three">
                                                        Quay lại
                                                    </p>
                                                </div>
                                            </div>
