...
export default function HomePageBeforLogin({ children }: any) {
    ...
    return (
        <>
            <Head>
                <title>Phần Mềm Quản Trị Nhân Sự Miễn Phí, Tốt Nhất 2023 - HRM365</title>
                <meta http-equiv="Content-Type" content="text/html;charset=utf-8"></meta>
                <meta name="viewport" content="width=device-width, initial-scale=1.0"></meta>
                <link rel="canonical" href="https://phanmemnhansu.timviec365.vn/"></link>
                <meta name="description" content="Phần mềm quản trị nhân sự 365 chuyên nghiệp, 
                giải pháp hàng đầu cho việc quản lý nhân sự của các doanh nghiệp. Download phần mềm quản lý nhân sự miễn phí"></meta>
                ...
                <div className={`${styles.container_fluid}`}>
                    <div className={`${styles.t_banner_home}`} style={{ display: "flex" }}>
                        <div className={`${styles.t_banner_home_1}`} style={{ width: "50%" }}>
                            <h1 className={`${styles.t_h1}`}>PHẦN MỀM QUẢN TRỊ NHÂN SỰ
                            </h1>
