...
import { POST_SS_VT, POST_VT } from "../api/BaseApi";
    ...
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center" }}>
        ...
        <div style={{ marginLeft: "10px" }}>
          <p
            style={{ fontWeight: "500", color: "#4C5BD4", marginBottom: "5px" }}
          >
            {name}
          </p>
          <p>ID: {id}</p>
            ...
            <div className={styles.body}>
              ...
              <div>
                ...
                <State
                  ...
                  time={dxDetail?.thoi_gian_tao &&
                    dxDetail?.thoi_gian_tao.toString().length > 10 ?
                      moment.unix(moment(dxDetail?.thoi_gian_tao).unix()).format('HH:mm A DD/MM/YYYY') :
                      moment.unix(dxDetail?.thoi_gian_tao).format('HH:mm A DD/MM/YYYY')}
                  name="Vũ Văn Khá"
                  icon="/add-circle.png"
                />

                {dxDetail?.thoi_gian_tiep_nhan !== 0 && <State
                  action="vừa tiếp nhận đề xuất"
                  time={moment(dxDetail?.thoi_gian_tiep_nhan).format('hh:mm A DD/MM/YYYY')}
                  name={dxDetail?.lanh_dao_duyet?.[0].userName}
                  icon="/share.png"
                />}

                {dxDetail?.thoi_gian_duyet !== 0 && <State
                  action="vừa duyệt đề xuất"
                  time={moment(dxDetail?.thoi_gian_duyet).format('hh:mm A DD/MM/YYYY')}
                  name={dxDetail?.lanh_dao_duyet?.[0].userName}
                  icon="/approve.png"
                />}
              </div>
