    ...
    <>
      <div className={`${styles.hs_t}`} ref={drop}>
        <div
          ...
          {item?.id !== 0 &&
            ...
            <p>
              ...
              {iconDelete && (
                <a
                  onClick={() => setDeleteProcess(item.id)}
                  style={{ cursor: 'pointer' }}>
                  Xóa
                </a>
              )}
        ...
        <div className={`${styles.hs_body}`}>
          {item?.id === 0 &&
            isProcessList?.listCandidate?.map((data: any, index: any) => {
              return (
                <ItemCandidate1
                  key={index}
          ...
          {item?.id !== 0 &&
            ...
            item?.id !== 3 &&
            item?.id !== 4 &&
            item?.listCandidate?.map((data: any, index: any) => {
              return (
                <ItemCandidate2
                  key={index}
                  process_id={item?.id}
          ...
          {item?.id === 1 &&
            isProcessList?.listCandidateGetJob?.map((data: any, index: any) => {
              return (
                <ItemCandidate3
                  key={index}
                  type='g'
          ...
          {item?.id === 2 &&
            isProcessList?.listCandidateFailJob?.map(
              (data: any, index: any) => {
                return (
                  <ItemCandidate3
                    key={index}
          ...
          {item?.id === 3 &&
            isProcessList?.listCandidateCancelJob?.map(
              (data: any, index: any) => {
                return (
                  <ItemCandidate3
                    key={index}
          ...
          {item?.id === 4 &&
            isProcessList?.listCandidateContactJob?.map(
              (data: any, index: any) => {
                return (
                  <ItemCandidate3
                    key={index}
