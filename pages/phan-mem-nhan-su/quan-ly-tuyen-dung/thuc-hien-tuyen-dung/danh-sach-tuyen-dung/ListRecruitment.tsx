...
import CreateSampleNews from "@/components/hr/quan-ly-tuyen-dung/thuc-hien-tuyen-dung/createSampleNews/CreateSampleNews";
...
export default function ListRecruitment({
  ...
  const [openModalSample, setOpenModalSample] = useState(false);
  ...
  const handleOpenModalSample = () => {
    setOpenModalSample(true);
    setAnimateModal(true);
  };
  ...
  const handleLinkClick = (e, id) => {
    e.preventDefault();
    router.push(
      `/phan-mem-nhan-su/quan-ly-tuyen-dung/thuc-hien-tuyen-dung/danh-sach-tuyen-dung/${id}`
    );
  };
  return (
    <>
            ...
            <div className={`${styles.new_r_t_header_content} `}>
              <h3 className={`${styles.new_r_t_left_h3}`}>
                ...
                >
                  ...
                  >
                    <a
                      href={`/phan-mem-nhan-su/quan-ly-tuyen-dung/thuc-hien-tuyen-dung/danh-sach-tuyen-dung/${data?.id}`}
              ...
              <div className={`${styles.pull_right} ${styles.hover_t}`}>
                ...
                {visible && (
                  <div className={`${styles.settings}`}>
                    ...
                    {iconEdit && (
                      <li onClick={handleOpenModalSample}>
          ...
          <div className={`${styles.new_r_t_body}`}>
            <ul className={`${styles.new_r_t_body_content}`}>
              ...
              <li>
                ...
                <span className={`${styles.text}`}>
                  {data?.address}(địa chỉ tuyển dụng){" "}
                </span>
              </li>
            </ul>
