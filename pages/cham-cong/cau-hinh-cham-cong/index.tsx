...
import {Button, DatePicker, DatePickerProps, Form, Select, SelectProps, Space} from "antd";
        ...
        <div className={styles.container}>
            ...
            <div className={styles.form_search}>
                <Form className={styles.form_search_item}>
                    ...
                    <Form.Item>
                        <Button className={styles.button_search}><SearchOutlined/>Tìm kiếm</Button>
                    </Form.Item>
                </Form>
            </div>
                    ...
                    <div className={styles.header_shift}>
                        ...
                        <div className={styles.body_shift}>
                            ...
                            <div className={styles.body_shift_div}>
                                <h4>
                                    Cài đặt chấm công trên app
                                </h4>
                               <div className={styles.body_shift_div_st}>
                                   <Checkbox>
                                       Chấm công khuân mặt trên app chat365
                                   </Checkbox>
                                   <Checkbox>
                                ...
                                <h4>
                                    Cài đặt chấm công tài khoản công ty
                                </h4>
                                <div className={styles.body_shift_div_st}>
                                    <Checkbox>
                                        Chấm công công ty
