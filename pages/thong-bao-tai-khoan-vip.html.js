            ...
            <div className={'khoi_header_content'} style={{width: '100%'}}>
               <div className='content_ql'>
                  <div className='cnt_ttone'>
                     <HeaderQLC setOpenSB={setOpenSB} openSB={openSB} currentPage={currentPage} />
                  </div>
                  <div className='register_ctnv register_dk_vip' id='register_nv'>
                     <div className='content_ql ctn_bgr_body' style={{margin: '0px'}}>
                                                ...
                                                <div className='box_hl_chat'>
                                                   <div className='ctn_hotline ctn_vipchung'>
                                                      <a rel='nofollow' target='_blank' href='tel:0983407428'>
                                                         ...
                                                         <span style={{width: '100%', textAlign: 'center'}}>(Call/Zalo)</span>
                                                      </a>
                                                   </div>
                                                   <div className='ctn_chat_vip ctn_vipchung'>
                                                      <a className='share_cursor' onclick='clk_chat(this)'>
