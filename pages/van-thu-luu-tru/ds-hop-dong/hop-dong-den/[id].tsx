...
import styles from "./detail_contract_to.module.css";
...
import Modal_del_contract from "@/components/van-thu-luu-tru/management_dispatch/modal_contract/Model_del";
import Modal_Update_contract from "@/components/van-thu-luu-tru/management_dispatch/modal_contract/Model_contract_update";
  ...
  return (
    <div className={styles.container}>
      ...
      <Modal_Update_contract
        href={`/van-thu-luu-tru/van-thu-luu-tru/ds-hop-dong/hop-dong-den`}
