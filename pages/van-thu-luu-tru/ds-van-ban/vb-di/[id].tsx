...
import Modal_dis_update_go from "@/components/van-thu-luu-tru/management_dispatch/model-dispatch/Model_Update_dispatch_go";
...
const Index = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <Modal_dis_update_go
        href={`/van-thu-luu-tru/ds-van-ban/vb-di/${dataDetail?._id}`}
