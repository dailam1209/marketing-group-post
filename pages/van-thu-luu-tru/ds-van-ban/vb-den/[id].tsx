...
import styles from "./detail_text_come.module.css";
...
import Modal_del from "@/components/van-thu-luu-tru/management_dispatch/model-dispatch/Model_del";
import Modal_Update_dispatch from "@/components/van-thu-luu-tru/management_dispatch/model-dispatch/Model_Update_dispatch";
  ...
  return (
    <div className={styles.container}>
      ...
      <Modal_Update_dispatch
        href={`/van-thu-luu-tru/ds-van-ban/vb-den/${dataDetail?._id}`}
