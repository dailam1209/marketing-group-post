          ...
          <div className={styles.list_box_data_top}>
            ...
            <div className={styles.list_box}>
              <div className={styles.item2}>
                ...
                <Link
                  href={`/van-thu-luu-tru/trang-chu-quan-ly-cong-van/lich-su-cap-nhat/1/1-2`}
              ...
              <div className={styles.item2}>
                ...
                <Link
                  href={`/van-thu-luu-tru/trang-chu-quan-ly-cong-van/lich-su-cap-nhat/2/1-2`}
                  className={styles.link_ct}
                >
                  Xem chi tiết
                </Link>
              ...
              <div className={styles.item2}>
                ...
                <Link
                  href={`/van-thu-luu-tru/trang-chu-quan-ly-cong-van/lich-su-cap-nhat/1/3-4`}
                  className={styles.link_ct}
                >
                  Xem chi tiết
                </Link>
              ...
              <div className={styles.item2}>
                ...
                <Link
                  href={`/van-thu-luu-tru/trang-chu-quan-ly-cong-van/lich-su-cap-nhat/2/3-4`}
                  className={styles.link_ct}
                >
                  Xem chi tiết
                </Link>
