...
import ListTrainingProcess from '@/components/hr/dao-tao-phat-trien/quy-trinh-dao-tao/listTrainingProcess/ListTrainingProcess'
  ...
  const listTab = [
    {
      ...
      component: (
        <ListTrainingProcess
          iconAdd={iconAdd}
          iconEdit={iconEdit}
          iconDelete={iconDelete}></ListTrainingProcess>
      ),
    },
  ]
