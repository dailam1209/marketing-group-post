...
export default function LoginCompany({ clientIp }) {
                        ...
                        <div className="form_dangnhap">
                            <div className="ctn_dangnhap">
                                <div className="cont_dangnhap">
                                    ...
                                    {<LoginForm setNotiError={setNotiError} typeLogin='1' showTab={showTab} />}
                                    {<LoginQr qrGuildShow={qrGuildShow} setNotiError={setNotiError} typeLogin='1' showTab={showTab} />}
                                </div>
                            </div>
                        </div>
                    </div>
