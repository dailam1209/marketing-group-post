...
import styles from './chi-tiet-nghi-che-do-thai-san.module.css'
...
const fakeData =
{
    ...
    duanthamgia: 'figma',
    lydothamgia: 'thayok',
    loainghiphep: 'khongluong',
    timestart: '18-07-2023',
    timeend: '18-12-2023',
    time: '07:27 AM',
    date: '07-04-2023',
    phanquyen: 0,
...
export const ChiTietCheDoNghiThaiSan: React.FC = () => {
                ...
                <div className={styles.body1}>
                    <div>
                        <div className={styles.title1}>
                            <p className={styles.texttitle1}>Đề xuất xin nghỉ chế độ thai sản</p>
                        </div>
                        ...
                        <div className={styles.infodexuat}>
                            ...
                            <div className={styles.ndinfodexuat}>
                                ...
                                <p className={styles.textinfo}>Loại nghỉ phép: {fakeData.loainghiphep}</p>
                        ...
                        <div className={styles.infochung}>
                            ...
                            <div className={styles.ndinfochung}>
                                ...
                                <p className={styles.textinfo}>2. Thời gian nghỉ từ ngày: {fakeData.timestart}</p>
                                <p className={styles.textinfo}>3. Đến ngày: {fakeData.timeend}</p>
                                <p className={styles.textinfo}>4. Lý do đề xuất xin nghỉ chế độ thai sản:</p>
