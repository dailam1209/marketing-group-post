...
import styles from './chi-tiet-khieu-nai.module.css'
...
export const ChiTietKhieuNai: React.FC = () => {
                ...
                <div className={styles.body1}>
                    <div>
                        <div className={styles.title1}>
                            <p className={styles.texttitle1}>Đề xuất khiếu nại</p>
                        </div>
                        ...
                        <div className={styles.infochung}>
                            ...
                            <div className={styles.ndinfochung}>
                                ...
                                <p className={styles.textinfo}>2. Nội dụng khiếu nại:</p>
