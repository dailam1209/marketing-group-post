...
import styles from './chi-tiet-tham-gia.module.css'
...
export const ChiTietThamGia: React.FC = () => {
                ...
                <div className={styles.body1}>
                    <div>
                        <div className={styles.title1}>
                            <p className={styles.texttitle1}>Đề xuất tham gia dự án</p>
                        </div>
                        ...
                        <div className={styles.infochung}>
                            ...
                            <div className={styles.ndinfochung}>
                                ...
                                <p className={styles.textinfo}>Chức vụ: {fakeData.chucvu}</p>
                                <p className={styles.textinfo}>3. Dự án đề xuất tham gia: {fakeData.duanthamgia}</p>
                                <p className={styles.textinfo}>4. Lý do đề xuất tham gia dự án:</p>
