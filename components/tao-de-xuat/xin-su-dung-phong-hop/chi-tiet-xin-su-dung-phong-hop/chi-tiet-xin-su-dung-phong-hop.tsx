...
import styles from './chi-tiet-xin-su-dung-phong-hop.module.css'
...
const fakeData =
{
    ...
    phanquyen: 1,
    chapthuan: 2,
    thoigiansudungtu:'04:30 CH 16-06-2023',
    denngay:'06:00 CH 16-06-2023'
}
const nguoiTheoDoi = [
    {
        id: '12345',
...
export const ChiTietXInSuDungPhongHop: React.FC = () => {
                ...
                <div className={styles.body1}>
                    <div>
                        <div className={styles.title1}>
                            <p className={styles.texttitle1}>Đề xuất xin sử dụng phòng họp</p>
                        </div>
                        ...
                        <div className={styles.infochung}>
                            ...
                            <div className={styles.ndinfochung}>
                                ...
                                <p className={styles.textinfo}>2. Thời gian sử dụng từ: {fakeData.thoigiansudungtu}</p>
                                <p className={styles.textinfo}>3. Đến ngày: {fakeData.denngay}</p>
                                <p className={styles.textinfo}>4. Lý do đề xuất xin sử dụng phòng họp:</p>
