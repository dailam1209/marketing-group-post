...
import styles from './chi-tiet-luan-chuyen.module.css'
...
const fakeData =
{
    ...
    noidangcongtac: 'phong1',
    noixinchuyenden: 'phong2',
    lydochuyen: 'thayok',
    time: '07:27 AM',
    date: '07-04-2023',
    phanquyen: 0,
...
export const ChiTietLuanChuyen: React.FC = () => {
                ...
                <div className={styles.body1}>
                    <div>
                        <div className={styles.title1}>
                            <p className={styles.texttitle1}>Đề xuất luân chuyển công tác</p>
                        </div>
                        ...
                        <div className={styles.infochung}>
                            ...
                            <div className={styles.ndinfochung}>
                                ...
                                <p className={styles.textinfo}>2. Phòng ban: {fakeData.phongban}</p>
                                <p className={styles.textinfo}>Chức vụ hiện tại: {fakeData.chucvu}</p>
                                <p className={styles.textinfo}>3. Nơi đang công tác: {fakeData.noidangcongtac}</p>
                                <p className={styles.textinfo}>4. Nơi xin chuyển đến: {fakeData.noixinchuyenden}</p>
                                <p className={styles.textinfo}>5. Lý do đề xuất luân chuyển công tác:</p>
                                <p className={styles.textinfo}>{fakeData.lydochuyen}</p>
                            </div>
                        </div>
                    </div>
