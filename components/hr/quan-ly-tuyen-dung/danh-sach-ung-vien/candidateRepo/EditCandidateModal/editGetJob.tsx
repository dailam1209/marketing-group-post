...
export default function EditCandidateGetJob({ onCancel, candidate }: any) {
  ...
  const [isEmpInterview, setEmpInterview] = useState<any>(null)
  ...
  const handleSubmit = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      const formDatas = {
        ...
        salary: salary || '',
        empInterview: isCandidate?.detail_get_job?.ep_interview || '',
      ...
      formData.append(
        'birthday',
        format(parseISO(candidate?.can_birthday), 'yyyy-MM-dd')
      )
      ...
      formData.append('address', candidate?.can_address)
      formData.append('userHiring', candidate?.user_hiring)
      formData.append('userRecommend', candidate?.user_recommend)
      formData.append('cvFrom', candidate?.cvFrom)
      formData.append(
        'timeSendCv',
        format(parseISO(candidate?.timeSendCv), 'yyyy-MM-dd')
      )
      ...
      formData.append('empInterview', isEmpInterview ? isEmpInterview : isCandidate?.detail_get_job?.ep_interview)
  ...
  const selectedEmpInterview: any = options.tennhanvientuyendung?.find(
    (item: any) => item.value === isCandidate?.detail_get_job?.ep_interview
  )
                ...
                <div className={`${styles.modal_body} ${styles.body_process}`}>
                  ...
                  <div className={`${styles.form_groups}`}>
                    ...
                    <div className={`${styles.input_right}`}>
                      <div className={`${styles.div_no_pad} `}>
                        <Select
                          value={options.tennhanvientuyendungdefault}
                  ...
                  <div className={`${styles.form_groups}`}>
                    ...
                    <div className={`${styles.input_right}`}>
                      <div className={`${styles.div_no_pad} `}>
                        <Select
                          value={options.tennhanviengioithieudefault}
                  ...
                  <div className={`${styles.form_groups}`}>
                    <label htmlFor=''>Thời gian nhận hồ sơ </label>
                    <div className={`${styles.input_right}`}>
                  ...
                  <div className={`${styles.form_groups}`}>
                    ...
                    <div className={`${styles.input_right} `}>
                      <input
                        ...
                        id='resiredSalary'
                        defaultValue={
                          isCandidate?.detail_get_job?.resired_salary
                        }
                        className={`${styles.input_process}`}
                      />
                      <span>
