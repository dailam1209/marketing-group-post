...
import { ProcessUpdate } from '@/pages/api/api-hr/quan-ly-tuyen-dung/candidateList'
...
export default function StageUpdateModal({
    ...
    const fetchData = async () => {
      try {
        ...
        if (formData) {
          ...
          const name = responseData?.data?.find(
            (item: any) => item.id === Number(infoList?.processBefore)
          )
          if (name) {
  ...
  const options = {
    ...
    giaidoandungtruocbefore: [
      { value: infoList?.processBefore, label: isProcessBeforeName },
    ],
  }
  return (
    <>
              ...
              <form action=''>
                <div className={`${styles.modal_body} ${styles.body_process}`}>
                  <div className={`${styles.form_groups}`}>
                    <label htmlFor=''>
                      Tên giai đoạn <span style={{ color: 'red' }}> * </span>
                    </label>
                    <div className={`${styles.input_right}`}>
                      <input
                        defaultValue={infoList?.name}
                        type='text'
                        id='names'
                        ...
                        {isProcessBeforeName && (
                          <>
                            <Select
                              ...
                              onChange={(option) =>
                                handleSelectChange(option, setProcess_id)
                              }
