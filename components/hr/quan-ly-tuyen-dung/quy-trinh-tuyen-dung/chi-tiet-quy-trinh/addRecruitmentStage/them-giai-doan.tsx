...
import { AddDataRecruitmentStage } from '@/pages/api/api-hr/quan-ly-tuyen-dung/RecruitmentManagerService'
export interface AddRecruitmentStage {}

export default function AddRecruitmentStage({
  recruitmentId,
  animation,
  onCloseModal,
  setData,
        ...
        <div
          ...
          <div className={`${styles.modal_dialog} ${styles.contentquytrinh}`}>
            <div className={`${styles.modal_content}`}>
              ...
              <form
                onSubmit={(e) => handleSubmit(e, recruitmentId, formData)}
