  ...
  <div
    ...
    <div className={`${styles.member_detail}`}>
      <div className={`${styles.member_details_header}`}>
        ...
        <button
          className={`${styles.hide_div_parent}`}
          style={{
            fontWeight: 500,
            background: 'unset',
            fontFamily: 'Roboto',
            fontSize: 16,
            display: name || name1 || name2 || name3 ? 'none' : 'inline',
          }}
          data-id='1'>
          (Ẩn)
        </button>
      ...
      <div className={`${styles.member_details_body}`}>
        <p>
          {position ? position : 'Họ và tên'}:{' '}
          {employee_number ? employee_number : name ? name : 'Chưa cập nhật'}
        </p>
    ...
    <div>
      <div className={`${styles.member_list}`}>
        <div className={`${styles.recruitment2}`}>
          <div className={`${styles.recruitment2_3}`}></div>
        </div>
            ...
            <div className={`${styles.genealogy_tree}`}>
              <Tree
                ...
                label={
                  <StyledNode>
                    <div
                      className={`${styles.member_view_box} ${styles.member_view_box_top}  ${styles.member_view_box_2_top} `}
                      style={{ width: 300, height: 100 }}>
                      <div className={`${styles.member_detail}`}>
                        <div
                          className={`${styles.member_view_box_2_top_header}`}>
                    ...
                    label={
                      <StyledNode>
                        <MemberViewBox1
                          ...
                          setOpenModalDetails={() =>
                            setOpenModalDetails(
                              PostionCharDatas?.data[0]?.mission
                            )
                          }
                          iconEdit={iconEdit}
                        />
                        ...
                        label={
                          <StyledNode>
                            <MemberViewBox1
                              ...
                              text_part={
                                PostionCharDatas?.data[1]?.positionName
                              }
                              ...
                              setOpenModalDetails={() =>
                                setOpenModalDetails(
                                  PostionCharDatas?.data[1]?.mission
                                )
                              }
                              iconEdit={iconEdit}
                            />
                          ...
                          <TreeNode
                            label={
                              <StyledNode>
                                <MemberViewBox1
                                  text_part={
                                    PostionCharDatas?.data[2]?.positionName
                                  }
                                  ...
                                  idPosition={
                                    PostionCharDatas?.data[2]?.positionId
                                  }
                                  mission={PostionCharDatas?.data[2]?.mission}
                                  handleUpdatePosition={handleUpdatePosition}
                                  setOpenModalDetails={() =>
                                    setOpenModalDetails(
                                      PostionCharDatas?.data[2]?.mission
                                    )
                                  }
                                  iconEdit={iconEdit}
                                />
                              ...
                              <TreeNode
                                label={
                                  <StyledNode>
                                    <MemberViewBox1
                                      text_part={
                                        PostionCharDatas?.data[3]?.positionName
                                      }
                                      name={PostionCharDatas?.data[3]?.users[0]}
                                      name1={
                                        PostionCharDatas?.data[3]?.users[1]
                                      }
                                      name2={
                                        PostionCharDatas?.data[3]?.users[2]
                                      }
                                      name3={
                                        PostionCharDatas?.data[3]?.users[3]
                                      }
                                      idPosition={
                                        PostionCharDatas?.data[3]?.positionId
                                      }
                                      mission={
                                        PostionCharDatas?.data[3]?.mission
                                      }
                                      handleUpdatePosition={
                                        handleUpdatePosition
                                      }
                                    ...
                                    label={
                                      <StyledNode>
                                        <MemberViewBox1
                                          ...
                                          name={
                                            PostionCharDatas?.data[4]?.users[0]
                                          }
                                          name1={
                                            PostionCharDatas?.data[4]?.users[1]
                                          }
                                          name2={
                                            PostionCharDatas?.data[4]?.users[2]
                                          }
                                          name3={
                                            PostionCharDatas?.data[4]?.users[3]
                                          }
                                          idPosition={
                                            PostionCharDatas?.data[4]
                                              ?.positionId
                                          ...
                                          mission={
                                            PostionCharDatas?.data[4]?.mission
                                          }
                                          handleUpdatePosition={
                                            handleUpdatePosition
                                          }
      ...
      {openModalEdit && (
        <EditPositionCharModal
          idPosition={openModalEdit}
          mission={isMission}
          onCancel={handleModalClose}></EditPositionCharModal>
      )}
      {openModalDetails && (
        <DetailsPositionCharModal
          mission={openModalDetails}
          onCancel={handleModalClose}></DetailsPositionCharModal>
      )}
