...
import { SealAndSignatureData } from "@/pages/api/api-hr/co_cau_to_chuc";
import { SignatureList } from "@/pages/api/api-hr/co_cau_to_chuc";
import { UploadSignature } from "@/pages/api/api-hr/co_cau_to_chuc";
