...
import { addDataListProcessTrain } from '@/pages/api/api-hr/dao-tao-phat-trien/TrainingProcess'
export default function AddTrainingProcess({
  animation,
  closeModal,
  handleNewData,
}: any) {
                ...
                <div className={`${styles.form_groups}`}>
                  ...
                  <div className={`${styles.inputright}`}>
                    <input
                      ...
                      placeholder='Nhập tên quy trình'></input>
                    {errors.name && (
                      <>
                        <picture>
                          <img
