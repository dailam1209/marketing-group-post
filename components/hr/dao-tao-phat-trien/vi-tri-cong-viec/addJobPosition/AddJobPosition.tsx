...
import { addDataJobPosition } from '@/pages/api/api-hr/dao-tao-phat-trien/JobPosition'
                ...
                <div className={`${styles.form_groups}`}>
                  ...
                  <div className={`${styles.inputright}`}>
                    <input
                      ...
                      placeholder='Nhập tên vị trí'></input>
                    {errors.name && (
                      <>
                        <picture>
                          <img
                ...
                <div className={`${styles.form_groups}`}>
                  ...
                  <div className={`${styles.file}`}>
                    <input
                      ...
                      accept='application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint,text/plain, application/pdf, image/*'></input>
                  </div>
                </div>
              </div>
              <div
