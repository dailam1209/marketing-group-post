...
export default function UpdatePolicyGroupsModal({
  onCancel,
  idGroup,
  ...
  const handleSubmit = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      const time_start = (
        document.getElementById('time-start') as HTMLInputElement
      )?.value
      const supervisor_name = (
        document.getElementById('supervisor-name') as HTMLInputElement
      )?.value
                  ...
                  <div
                    ...
                    <div className={`${styles.form_groups}`}>
                      ...
                      <div className={`${styles.input_right}`}>
                        <input
                          ...
                          defaultValue={DetailData?.data[0]?.supervisorName}
                          className={`${styles.input_process}`}
                        />
                      </div>
                    </div>
                    <div className={`${styles.form_groups} ${styles.cke}`}>
                      ...
                      <div className={`${styles.ckeditor}`}>
                        <Input_textarea
                          content={DetailData?.data[0]?.description}
