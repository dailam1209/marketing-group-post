...
export default function RegulationsWork({ iconAdd, iconEdit, iconDelete }) {
  ...
  const handleOpendetailRegulation = (
    id: number,
  ...
  const handleOpenDeleteRegulations = (
    id: number,
    event: React.MouseEvent<HTMLInputElement>
  ) => {
    event.preventDefault()
        ...
        <div className={`${styles.tab_pane} ${styles.fade} `}>
          <div className={`${styles.recruitment2}`}>
            <div className={`${styles.recruitment2_3}`}>
              ...
              {openModal === 1 && (
                <AddRegulationsModal
                  onCancel={handleCloseModal}></AddRegulationsModal>
              )}
              {openModal === 2 && (
                <AddRegulationsModal2
                  onCancel={handleCloseModal}></AddRegulationsModal2>
              )}
              {openDetail !== 0 && (
                <GroupDetailModal
                  idGroup={idDetail}
              ...
              {openDetailRegulation !== 0 && (
                <RegulationDetailModal
                  idGroup={idDetailRegulation}
                  onCancel={handleCloseModal}
                />
              )}
              {openDeleteRegulation !== 0 && (
                <DeleteRegulation
                  idGroup={idDeleteRegulation}
                  onCancel={handleCloseModal}
                />
              )}
            </div>
