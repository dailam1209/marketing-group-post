...
import { PayrollDownList } from '@/pages/api/api-hr/bien_dong_nhan_su'
          ...
          <div className={`${styles.body} ${styles.body_planning}`}>
            <div className={`${styles.recruitment}`}>
              ...
              <div
                ...
                <a
                  href=''
                  className={`${styles.t_excel} ${styles.t_excel_payroll}`}>
            ...
            {openModal === 1 && (
              <AddPayrollModal onCancel={handleCloseModal}></AddPayrollModal>
            )}
            {openEditModal === true ? (
              <EditPayroll
                onCancel={handleCloseModal}
                infoList={infoList}></EditPayroll>
            ) : (
              ''
            )}
            {openDeleteModal !== 0 && (
                  ...
                  <tbody className={`${styles.filter_body}`}>
                    {PayrollDownLists?.data?.map((item: any, index: any) => (
                      <tr key={index}>
                        ...
                        <td>
                          {item.type === 2 ? 'Nghỉ việc' : 'Giảm biên chế'}
                        </td>
