...
import { AddPayrollDown, ShiftList } from '@/pages/api/api-hr/bien_dong_nhan_su'
...
export default function EditPayroll({ onCancel, infoList }: any) {
  ...
  useEffect(() => {
    ...
    const matchingDep = isDepList?.data?.find(
      (item: any) => item?.dep_name === infoList?.dep_name
    )
    const matchingPos = isPositionList?.data
      ?.flat()
      ?.find((item: any) => item?.positionName === infoList.position_name)
  ...
  const choncanghiOptions = useMemo(
    () =>
      isShiftList &&
      isShiftList?.list?.map((shift: any) => ({
  ...
  const options = {
    ...
    chonphongban: [{ value: isDep_id, label: infoList.dep_name }],
    chonnhanvien: [{ value: infoList?.ep_id, label: infoList?.ep_name }],
                ...
                <form action=''>
                  <div className={`${styles.form_groups}`}>
                    ...
                    <div className={`${styles.input_right}`}>
                      <Select
                        ...
                        onChange={(option) =>
                          handleSelectChange(option, options.chonnhanvien)
                        }
                  ...
                  <div className={`${styles.form_groups}`}>
                    ...
                    <div className={`${styles.input_right}`}>
                      <Select
                        ...
                        onChange={(option) =>
                          handleSelectChange(option, options.chucvuhientai)
                        }
                  ...
                  <div className={`${styles.form_groups}`}>
                    ...
                    <div className={`${styles.input_right}`}>
                      <Select
                        ...
                        onChange={(option) =>
                          handleSelectChange(option, options.chonphongban)
                        }
                  ...
                  <div className={`${styles.form_groups}`}>
                    ...
                    <div className={`${styles.input_right}`}>
                      <Select
                        ...
                        onChange={(option) =>
                          handleSelectChange(option, options.chonchinhanh)
                        }
                  ...
                  <div className={`${styles.form_groups}`}>
                    ...
                    <div className={`${styles.input_right}`}>
                      <Select
                        ...
                        onChange={(option) =>
                          handleSelectChange(option, setShift_id)
                        }
                  ...
                  <div className={`${styles.form_groups}`}>
                    ...
                    <div className={`${styles.input_right}`}>
                      <Select
                        defaultValue={selectedOption}
                        onChange={(option) =>
                          handleSelectChange(option, setType_id)
                        }
                  ...
                  <div className={`${styles.form_groups} ${styles.cke}`}>
                    ...
                    <div className={`${styles.ckeditor}`}>
                      <Input_textarea
                        onDescriptionChange={handleInputAreaChange}
                        reason={infoList.note}
                      />
                    </div>
                  </div>
                  <div
