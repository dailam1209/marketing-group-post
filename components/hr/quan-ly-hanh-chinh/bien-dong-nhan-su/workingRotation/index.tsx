...
import { WorkingRotaionList } from '@/pages/api/api-hr/bien_dong_nhan_su'
...
export default function TabWorkingRotation({
  iconAdd,
  iconEdit,
  iconDelete,
}: any) {
      ...
      <div className={`${styles.tab_content}`}>
        <div className={`${styles.tab_pane}`}>
          <div className={`${styles.body} ${styles.body_planning}`}>
            ...
            {openModal === 1 && (
              <AddWorkingModal onCancel={handleCloseModal}></AddWorkingModal>
            )}
            {openEditModal && (
              <EditWorkingModal
                          ...
                          <td>
                            {iconEdit && (
                              <a
                                ...
                                onClick={() =>
                                  handleOpenEdit({
                                    com_name: item.new_com_name,
                                    dep_name: item.new_dep_name,
                                    emp_name: item.userName,
                                    position_name: item.new_position,
                                    ep_id: item.ep_id,
                                    note: item.note,
                                    mission: item.mission,
                                    dep_id: item.new_dep_id,
                                  })
                                }
