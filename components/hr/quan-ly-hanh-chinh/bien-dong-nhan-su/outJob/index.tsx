...
import { OutJobList } from '@/pages/api/api-hr/bien_dong_nhan_su'
      ...
      <div className={`${styles.tab_content}`}>
        <div className={`${styles.tab_pane}`}>
          <div className={`${styles.body} ${styles.body_planning}`}>
            ...
            {openModal === 1 && (
              <AddOutJobModal onCancel={handleCloseModal}></AddOutJobModal>
            )}
            ...
            <div
              ...
              <div className={`${styles.table_content}`} ref={tableContentRef}>
                <table
                  className={`${styles.table} ${styles.table_list}`}
                  style={{ width: '150%' }}>
                  <thead>
                    <tr>
                      <th>ID nhân viên</th>
