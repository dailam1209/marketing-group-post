...
import {
  OutJobList,
  PayrollDownList,
  PlanningAppointmentList,
  WorkingRotaionList,
} from '@/pages/api/api-hr/bien_dong_nhan_su'

const Chart = (data: any) => {
  const [isPlanningAppointmentList1, setPlanningAppointmentList1] =
    useState<any>(null)
  const [isPlanningAppointmentList2, setPlanningAppointmentList2] =
    useState<any>(null)
