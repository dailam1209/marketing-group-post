...
export default function EditCandidateList({
  onCancel,
  infoList,
  position,
}: any) {
  ...
  const handleSubmit = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      const names = (document.getElementById('names') as HTMLInputElement)
        ?.value
      const dateInCom = (
        document.getElementById('date_in_com') as HTMLInputElement
      )?.value
                ...
                <div className={`${styles.modal_body} ${styles.body_process}`}>
                  ...
                  <div
                    ...
                    <div className={`${styles.content_right}`}>
                      <div
                        className={`${styles.form_groups} ${styles.form_groups5} ${styles.form_groups6}   `}>
                        <label htmlFor=''>
                          Điện thoại{' '}
                    ...
                    <div className={`${styles.content_left}`}>
                      <div
                        ...
                        <Select
                          ...
                          onChange={(option) =>
                            handleSelectChange(option, setGender)
                          }
                    ...
                    <div className={`${styles.content_right}`}>
                      <div
                        ...
                        <Select
                          defaultValue={selectedOption}
                          onChange={(option) =>
                            handleSelectChange(option, setMaritalStatus)
                          }
                  ...
                  <div className={`${styles.form_groups}`}>
                    ...
                    <Select
                      defaultValue={selectedOption}
                      onChange={(option) =>
                        handleSelectChange(option, setEducation)
                      }
