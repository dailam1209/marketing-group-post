  ...
  <div className="footer_content">
    ...
    <div className="footer_block2">
      <div className="about_365">
        <div className="wrap_arr open_content">
        ...
        <div className="list_about_365 content_show">
          <div className="timviec_item">
            <div className="content_item">
              <a
                rel="nofollow"
                href="https://timviec365.vn/gioi-thieu-chung.html"
              >
                Giới thiệu
              </a>
              <a
                rel="nofollow"
                href="https://timviec365.vn/thong-tin-can-biet.html"
              >
                Thông tin
              </a>
              <a
              ...
              <a
                rel="nofollow"
                href="https://timviec365.vn/thoa-thuan-su-dung.html"
              >
                Thỏa thuận
              </a>
              <a
                rel="nofollow"
                href="https://timviec365.vn/quy-dinh-bao-mat.html"
              >
                Bảo mật
              </a>
            </div>
            <div className="content_item">
              <a
                rel="nofollow"
                href="https://timviec365.vn/giai-quyet-tranh-chap.html"
              >
                Giải quyết tranh chấp
              </a>
              <a
                rel="nofollow"
                href="https://timviec365.vn/so-do-trang-web.html"
              >
                Sơ đồ Website
              </a>
              <a
      ...
      <div className="footer_block2_right">
          ...
          <div className="list_for_uv content_show">
            <div className="timviec_item">
              <div className="content_item">
                ...
                <a href="https://timviec365.vn/cv365/mau-don-xin-viec">
                  Hồ sơ xin việc
                </a>
              </div>
              <div className="content_item">
                <a href="https://timviec365.vn/blog/c24/bi-quyet-viet-cv">
                  Bí quyết viết CV
                </a>
                <a
                  rel="nofollow"
          ...
          <div className="list_tien_ich content_show">
            <div className="timviec_item">
              ...
              <div className="content_item">
                ...
                <a
                  href="https://timviec365.vn/tinh-bao-hiem-that-nghiep"
                  rel="nofollow"
                >
          ...
          <div className="list_work_job content_show">
            <div className="timviec_item">
              <div className="content_item">
                ...
                <a href="https://timviec365.vn/viec-lam-bao-hiem-c66v0">
                  Việc làm bảo hiểm
                </a>
                <a href="https://timviec365.vn/viec-lam-it-phan-mem-c13v0">
                  Việc làm IT
                </a>
              </div>
              <div className="content_item">
                <a href="https://timviec365.vn/viec-lam-nhan-su-c27v0">
                  Việc làm nhân sự
                </a>
                <a href="https://timviec365.vn/viec-lam-ban-hang-c10v0">
                  Việc làm bán hàng
                </a>
                <a href="https://timviec365.vn/viec-lam-luong-cao.html">
                  Việc làm lương cao
                </a>
        ...
        <div className="work_tag">
          ...
          <div className="list_work_tag content_show">
            <div className="timviec_item">
              <div className="content_item">
                <a href="https://timviec365.vn/tim-viec-lam-php-t11394.html">
                  Việc làm PHP
                </a>
    ...
    <div className="footer_block3">
      ...
      <div className="wrap_address">
        ...
        <p className="wrap_address_txt">Email: timviec365.vn@gmail.com</p>
      </div>
