...
export default function SideBar() {
        ...
        <div className="ctn_qly_left">
            ...
            <div className="nav_qly">
                <ul className="navbar-nav">
                    ...
                    <a href="/quan-ly-thong-tin-tai-khoan-cong-ty.html" className="nav-item" >
                        <li className="nav-child-item cr_weight_bold share_fsize_tow share_clr_tow d_flex">
                            <span className="item_ic"><img src="../img/qly-tttaikhoan.png" alt="Thông tin tài khoản" /></span>
                            Thông tin tài khoản
                        </li>
                    ...
                    <a href="/cai-dat-thiet-lap-dai-ip-phan-mem.html" className="nav-item" >
                        <li className="nav-child-item cr_weight_bold share_fsize_tow share_clr_tow d_flex">
    ...
    const render_html = linkHome === 'quan-ly-ung-dung-cong-ty.html' ? html2 : html1;
