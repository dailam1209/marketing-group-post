...
const Modal_contract: React.FC<ModalProps> = ({
  isOpen,
  onClose,
  title,
  item,
  ...
  interface FormValues {
    ...
    text_gui_vbden: string;
    user_gui_vbden: string;
    user_gui_vbden1: string;
    text_user_gui_vbden: string;
    date_nhan: string;
  ...
  const initialValues: FormValues = {
    ...
    user_gui_vbden: "",
    user_gui_vbden1: "",
    text_user_gui_vbden: "gà",
    date_nhan: "",
    use_nhan_vbden: "",
    use_luu_vbden: "",
    book_vb: "",
    trich_yeu_vbden: "rất là n",
    ghi_chu_vbden: "",
    user_ky: "",
    money_hd: "",
    file: null,
      ...
      try {
        ...
        if (Object.keys(errors).length === 0) {
          ...
          if (values.type_gui_vbden == "2") {
            // Cần id nơi gửi và người gửi chưa có nên chú ý
            formdata.append("noi_gui_vbden", values.noi_gui_vbden1);
            formdata.append("user_gui_vbden", values.user_gui_vbden1);
          }
          formdata.append("text_gui_vbden", values.text_gui_vbden);
          formdata.append("text_user_gui_vbden", values.text_user_gui_vbden);
          ...
          formdata.append("user_ky", values.user_ky);
          formdata.append("money_hd", values.money_hd);
          if (values.file) {
            formdata.append("file", values.file);
          }
          try {
            const apiURL = `${baseURL}api/vanthu/contract/createSendContract`;
              ...
              <div className={styles.form_body}>
                ...
                <div className={styles.form_group}>
                  ...
                  <Select
                    ...
                    options={ds_empla_options}
                    value={ds_empla_options?.find(
                      (option: any) => option.value === formik.values.user_ky
                    )}
                    // fake tạm thời đang sai thêm văn bản đi
                    onChange={(option) =>
                      formik.setFieldValue(
