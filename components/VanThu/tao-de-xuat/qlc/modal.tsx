...
export const MyInput = (
  ...
  <Form.Item
    ...
    label={hasLabel && <p style={{fontWeight:'500',fontSize: '16px'}}>{title}</p>}
    labelCol={{ span: 24 }}
  >
    {type && type === "number" ? (
      <InputNumber
        placeholder={placeholder}
        style={{ width: "100%", border: "1px solid rgb(159, 159, 159)" }}
        size="large"
        disabled={disabled}
      />
    ) : (
...
export const MyTextArea = ({
  ...
  return (
    <Form.Item
      ...
      labelCol={{ span: 24 }}
    >
      <TextArea rows={5} style={{ width: "100%", border: "1px solid rgb(159, 159, 159)", borderRadius: "6px",  }} placeholder={placeholder} />
    </Form.Item>
  );
};
