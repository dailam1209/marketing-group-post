...
import { post_asset_allocation_propose } from "@/utils/api/dexuat/api_post";
import axios from "axios";
import router from "next/router";

const Asset_allocation_propose = ({ inuse }: { inuse?: boolean }) => {
  const validationSchema = Yup.object().shape({
    ...
    danh_sach_tai_san: Yup.string().required("Vui lòng nhập tên tài sản."),
    so_luong_tai_san: Yup.string().required("Vui lòng nhập số lượng tài sản."),
  });
  ...
  return (
    <form className={styles.form_propose}>
      <div className={styles.wrapper_form}>
        ...
        <span className={styles.asset_list_title}>
          ...
          <Section
            ...
            input={
              <Custom_input_text
                ...
                input_name="danh_sach_tai_san"
                handleChange={handleInputChange}
              />
            }
            validation={
              errors.danh_sach_tai_san && (
                <p style={{ color: "red", margin: "10px 10px 10px 0" }}>
                  {errors.danh_sach_tai_san}
                </p>
              )
          ...
          <Section
            ...
            input={
              <Custom_input_text
                ...
                type="number"
                input_name="so_luong_tai_san"
                handleChange={handleInputChange}
              />
            }
            validation={
              errors.so_luong_tai_san && (
                <p style={{ color: "red", margin: "10px 10px 10px 0" }}>
                  {errors.so_luong_tai_san}
                </p>
              )
...
export default Asset_allocation_propose;
