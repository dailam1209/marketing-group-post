    ...
    <div className={`${styles.menu}`}>
      <ul>
        ...
        >
          <Sidebar_btn
            sendDataToParent={handleReceiveDataFromChild}
            href="/van-thu-luu-tru/trang-chu-quan-ly-cong-van/lich-su-cap-nhat"
        ...
        >
          <Sidebar_btn
            sendDataToParent={handleReceiveDataFromChild}
            href="/van-thu-luu-tru/trang-chu-quan-ly-cong-van/tra-nhanh-van-ban"
        ...
        >
          <Sidebar_btn
            sendDataToParent={handleReceiveDataFromChild}
            href="/van-thu-luu-tru/trang-chu-quan-ly-cong-van/cai-dat-quan-ly-cong-van"
        ...
        >
          <Sidebar_btn
            sendDataToParent={handleReceiveDataFromChild}
            href="/van-thu-luu-tru/trang-chu-quan-ly-cong-van/du-lieu-da-xoa"
