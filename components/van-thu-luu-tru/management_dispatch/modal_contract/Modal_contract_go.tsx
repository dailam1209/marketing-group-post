...
const Modal_contract_go: React.FC<ModalProps> = ({
  isOpen,
  onClose,
  title,
  item,
    ...
    onSubmit: async (values, { resetForm }) => {
      try {
        ...
        if (Object.keys(errors).length === 0) {
          ...
          // Theo api thì phải có trước nhận nội bộ đi và người nhận nội bộ
          ...
          values.nhanvb_dep.forEach((dep) => {
            ...
            // Theo logic đúng
            // if (dep == 1 && values.nhan_noibo_vb_di != "") {
            //   formdata.append("nhan_noibo_vb_di", values.nhan_noibo_vb_di);
            // }
          ...
          values.nhanvb_use.forEach((user) => {
            ...
            // if (user == 1 && values.nhan_use_vbdi) {
            //   formdata.append("nhan_use_vbdi", values.nhan_use_vbdi);
            // }
          ...
          try {
            const apiURL = `${baseURL}api/vanthu/contract/createContract`;
                            ...
                            >
                              <div className={styles.info_user}>
                                ...
                                <div style={{ marginLeft: "12px" }}>
                                  ...
                                  <span>
                                    {(formik.values.file.size / 1024).toFixed(
                                      2
                                    )}{" "}
                                    KB
                                  </span>
...
export default Modal_contract_go;
