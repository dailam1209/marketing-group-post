...
import Report_left from "@/components/van-thu-luu-tru/send_and_receive/reports/Report_left";
import Report_right from "@/components/van-thu-luu-tru/send_and_receive/reports/Report_right";
import Box_bottom_right from "@/components/van-thu-luu-tru/send_and_receive/reports/components/box_bottom_right";
import Box_children_bottom_right from "@/components/van-thu-luu-tru/send_and_receive/reports/components/box_children_bottom_right";
import Box_top_right from "@/components/van-thu-luu-tru/send_and_receive/reports/components/box_top_right";
import Image from "next/image";
import styles from "./Comp_detail.module.css";
import Link from "next/link";
import { AiOutlineArrowDown } from "react-icons/ai";
import { useState } from "react";
import Modal_forward from "@/components/van-thu-luu-tru/send_and_receive/modal/Modal_forward";
import Modal_internal_save from "@/components/van-thu-luu-tru/send_and_receive/modal/Modal_ internal_save";
import Modal_feedback from "@/components/van-thu-luu-tru/send_and_receive/modal/Modal_feedback";
