...
export function DanhSachTo({ listTeams, infoCom, listDepartments }: { listTeams: any, infoCom: any, listDepartments: any}) {
      ...
      <Row gutter={{ lg: 15, md: 20, sm: 20 }}>
        <Col lg={10} md={11} sm={12} xs={24}>
          <Row gutter={20}>
            ...
            <Col sm={24} xs={24}>
              <div>{MySelect("", "Chọn tổ", false, false, "team_id", data.map(team => ({ label: team?.team_name, value: team?.team_id })))}</div>
            </Col>
          </Row>
        </Col>
