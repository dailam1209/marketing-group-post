...
export default function AddTable() {
  return (
    <div>
      ...
      <p  style={{marginLeft:'15px'}}  className={styles.main__body__type}>Thông tin hàng hóa</p>
        ...
        <div className={`${styles.row}`}>
          <div className={`${styles["col-lg-3"]} }`}>
            <div className={`${styles.main__body__item} ${styles.d_flex} ${styles.justify_content_between} `}>
              ...
              <div className={`${styles.main__body__item__title}`}><b>Chiết khấu đơn hàng:</b></div>
          ...
          <div className={`${styles["col-lg-3"]} `}>
            <div className={`${styles.main__body__item} ${styles.d_flex} ${styles.justify_content_between} `}>
              ...
              <div className={`${styles.main__body__item__title}`}><b>&nbsp;</b></div>
