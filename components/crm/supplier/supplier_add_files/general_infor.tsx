...
import SupplierSelectBoxStep from "../supplier_steps/select_box_step";
    ...
    <div>
      ...
      <div className={styles.row_input}>
        <div className={`${styles.mb_3} ${styles["col-lg-6"]}`}>
          <label className={`${styles["form-label"]}`} style={{
            fontWeight: "bold",
            }}>
              Mã nhà cung cấp
          </label>
        ...
        }} prefix="Hệ thống tự động thiết lập" disabled />
        </div>

        <label className={`${styles.mb_3} ${styles["col-lg-6"]}`}>
            <div >
              <label className="bank" style={{
                  fontWeight: "bold"
                }}>
                  Ngân hàng
                </label>
            ...
            <Select
                ...
                options={[
                  ...
                  {
                    value: 'agri',
                    label: 'NH Nông nghiệp và Phát triển Nông thôn Việt Nam (Agribank)',
                  },
                  {
                    value: 'acb',
      ...
      <div className={styles.row_input}>
        <InputText label="Tên nhà cung cấp" placeholder="Nhập tên nhà cung cấp" />
      ...
      <div className={styles.row_input}>
        <div className={`${styles.mb_3} ${styles["col-lg-6"]}`}>  <InputText
          label="Email"
        ...
        <label style={{width:"100%"}}>
          <div className={styles.wrap_label}>
            ...
            <button style={{marginLeft: "50%", fontSize: 16, color: "#4C5BD4"
            }}>
              Tạo nhóm</button>
          </div>
          <Select
