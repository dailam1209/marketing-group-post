...
export default function WriteBillRowInforText2({formData}:any) {
  return (
    <div className={styles.row_input_text}>
      ...
      <InforText field="Tỉnh/Thành phố:" value={formData?.ship_city}/>
      <InforText field="Quận/Huyện:" value={formData?.giao_hang_huyen?formData?.giao_hang_huyen:"Chưa cập nhật"}/>
