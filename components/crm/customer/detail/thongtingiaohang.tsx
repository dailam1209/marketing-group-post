...
export default function WriteBillRowInforText2({formData}:any) {
  return (
    <div className={styles.row_input_text}>
      ...
      <InforText field="Tỉnh/Thành phố:" value={formData?.giao_hang_tp?.name}/>
      ...
      <InforText field="Số nhà, đường phố:" value={formData?.so_nha_duong_pho?.name?formData?.so_nha_duong_pho?.name:"Chưa cập nhật"}/>
