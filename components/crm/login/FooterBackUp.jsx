                            ...
                            <div className={styles.about_365}>
                                <div
                                    ...
                                    onClick={
                                        getCheck
                                            ? (event) =>
                                                  seeNvAllClickHandlerRef.current(
                                                      event,
                                                      0
                                                  )
                                            : null
                                ...
                                >
                                    ...
                                    <div
                                        className={`${styles.arr_respon} ${styles.hidden}`}
                                    >
                                        <img
                        ...
                        <div className={styles.ft_bottom}>
                            <div className={styles.left}>
                                <div className={styles.left_top}>
                                    ...
                                    <a href="#">
                                        <span className={styles.custom_span}>
                                            VP3: Tầng 2, Số 1 Đường Trần Nguyên
                                            Đán, KĐT Định Công, Hoàng Mai, Hà
                                            Nội
                                        </span>
                                    </a>
