      ...
      {checkHomeIfLoggedIn() ? null : (
        <div className={styles.main}>
          <Head>
            ...
            <title>
              Phần mềm CRM 365 - Quản lý Quan hệ khách hàng miễn phí
            </title>
            <meta
              name="description"
            ...
            <meta
              name="Keywords"
              content="Phần mềm CRM, phần mềm crm miễn phí"
            />
            ...
            <div className={styles["banner-left"]}>
              <div className={styles["text-top"]}>
                <h1 className={styles["title_banner"]}>
                  CRM – gắn kết doanh nghiệp – khách hàng bền vững
                </h1>
          ...
          <div className={styles["content-body"]}>
              ...
              <div className={styles["item"]}>
                <div className={`${styles["item-01"]} ${styles["item-child"]}`}>
                  ...
                  <p className={styles["text_box"]}>
                    Dữ liệu khách hàng tập trung. Thông tin khách hàng đồng bộ
                    và nhất quán.
                  </p>
                </div>
                <div className={`${styles["item-02"]} ${styles["item-child"]}`}>
                  ...
                  <p className={styles["text_box"]}>
                    ...
                    bằng công cụ hỗ trợ bán hàng chuyên nghiệp. Tỷ lệ quay lại
                    mua hàng cao.
                  </p>
                </div>
                <div className={`${styles["item-03"]} ${styles["item-child"]}`}>
                  ...
                  <p className={styles["text_box"]}>
                    Xây dựng chiến dịch phù hợp với từng phân khúc khách hàng.
                    Đo lường và đánh giá hiệu quả chiến dịch một cách toàn diện.
                    Tiết kiệm tối đa chi phí tiếp thị và thu hút khách hàng.
                  </p>
                </div>
                <div className={`${styles["item-04"]} ${styles["item-child"]}`}>
                  ...
                  <p className={styles["text_box"]}>
                    Hệ thống báo cáo đầy đủ, rõ ràng và chi tiết. Quản trị tổng
                    quan tình hình doanh thu một cách chính xác. Dễ dàng giám
                    sát được năng suất và hiệu quả làm việc.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className={styles["right-03"]}>
                <div className={styles["text-03"]}>
                  ...
                  <p className={styles["title_content_box_03"]}>
                    Trải nghiệm ngay giải pháp công nghệ hàng đầu CRM365 để
                    không bỏ lỡ cơ hội giúp doanh nghiệp của bạn tối ưu toàn bộ
                    chi phí, tăng trưởng doanh thu thần tốc, và tiết kiệm thời
            ...
            <div className={styles["box-05"]}>
              <div className={styles["text-05"]}>
                <h2
                  className={`${styles["title_box"]} ${styles["title_box_05"]}`}
                >
                  CRM 365 được tin dùng bởi
                  <span style={{ color: "#FFA800" }}>1000+</span> đối tác trên
                  khắp cả nước
                </h2>
