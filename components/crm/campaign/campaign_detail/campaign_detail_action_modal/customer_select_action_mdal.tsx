...
const CancelModal: React.FC<MyComponentProps> = ({
  ...
  return (
    <>
      ...
      >
        {/* <TabOrderList /> */}
        <div style={{ marginTop: "0px" }} className={`${styles.main__control_btn} flex_between`}>
          ...
          {
            <TableDataCampaignCustomerSelect setSelected={setIsSelectedRow} setNumberSelected={setNumberSelected}/>
          }
