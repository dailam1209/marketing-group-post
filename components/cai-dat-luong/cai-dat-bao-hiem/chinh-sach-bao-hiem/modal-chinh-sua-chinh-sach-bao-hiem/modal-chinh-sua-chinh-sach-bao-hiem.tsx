import { Row, Col, Modal, Input, Checkbox, Button, List, Divider, Skeleton, Form  } from "antd"
    ...
    >
      ...
      <div className={styles.body}>
        ...
        <div className={styles.bodyItem}>
          ...
          <Input style={{ fontSize: "16px", border: "1px solid #9F9F9F" }} placeholder="Nhập tên bảo hiểm"></Input>
          </Form.Item>
        </div>
        <div className={styles.bodyItem}>
          Miêu tả chính sách
          <Form.Item name={"cl_note"}>
          <Input.TextArea placeholder="Nhập miêu tả" className={styles.textArea}></Input.TextArea>
          </Form.Item>
        </div>
        </Form>
