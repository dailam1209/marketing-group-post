...
export default function HeaderQLC({currentPage, openSB, setOpenSB, setOpenModalRegister, setOpenModalLogin}) {
   ...
   return (
      <>
         <div className={styles.HeaderQLC}>
            <div className={styles.hambuger_close} onClick={() => setOpenSB(!openSB)}>
               {openSB === true ? <img src='./qlc_close.png' alt='' /> : <img src='./hamburger.png' alt='' />}
            </div>
               ...
               <div className={styles.log}>
                  {renderContent ? (
                     <>
                        <div className={styles.noty_user}>
                           <div className={styles.notify}>
                              <img src='./qlc_notification.png' alt='' className={styles.img_noti} />
                              <img src='./notify_fill.png' alt='' className={styles.img_noti_fill} />
                              <span>2</span>
                           </div>
                           <div className={styles.user} onClick={optionUser}>
                              <div className={styles.img_user}>
                                 {data.avatarUser ? (
                                    ...
                                    <img src='../img/logo_com.png' alt='' className={styles.avt_img_tk} />
                                 )}
                                 <span>{data.userName}</span>
                                 {/* <span>Nguyễn Quốc Doanh</span> */}
                              </div>

                              <img src='./arrow_down_black.png' alt='' className={styles.arrow} />
                     ...
                     <div className={styles.register_login}>
                        <span className={styles.register} onClick={() => setOpenModalRegister(true)}>
                           Đăng ký
                        </span>
                        <span>/</span>
                        <span className={styles.login} onClick={() => setOpenModalLogin(true)}>
                           Đăng nhập
                        </span>
                     </div>
                  )}
