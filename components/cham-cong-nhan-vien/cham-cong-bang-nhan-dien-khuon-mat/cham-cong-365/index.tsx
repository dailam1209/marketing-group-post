...
export function BANNER_CCBNDKM_CHAMCONG365() {
  ...
  const [listSteps, setListSteps] = useState([
    {
      title: 'Tại Trang chủ, chọn “Chấm công”',
      clicked: true,
      img: '/ccbndkm_chamcong365_1.png',
    },
    {
      title:
      ...
      clicked: false,
      img: '/ccbndkm_chamcong365_2.png',
    },
    {
      title:
        'Nếu chấm công thành công, sẽ có màn hình thông báo chấm công thành công màu xanh, còn nếu chấm công thất bại, sẽ có thông báo màu đỏ trên màn hình, hãy chọn CHẤM CÔNG LẠI.',
      clicked: false,
      img: '/ccbndkm_chamcong365_3.png',
    },
  ])
      ...
      <div className={styles.body}>
        ...
        <div className={styles.bodyItem3}>
          ...
          <div
            ...
            onClick={HandleNavigationChat365}>
